...
urlpatterns = [ 
    ...
    path("categories/<slug:slug>/", views.CategoryViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name="category-detail"),

    # ✅ Product
    path("products/", views.ProductViewSet.as_view({'get': 'list', 'post': 'create'}), name="product-list"),
    path("products/<slug:slug>/", views.ProductViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name="product-detail"),

    # ✅ Cart
    path("carts/", views.CartViewSet.as_view({'get': 'list', 'post': 'create'}), name="cart-list"),
    path("carts/<int:pk>/", views.CartViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name="cart-detail"),
    path("carts/<int:pk>/add-item/", views.CartViewSet.as_view({'post': 'add_item'}), name="cart-add-item"),
    path("carts/<int:pk>/remove-item/", views.CartViewSet.as_view({'post': 'remove_item'}), name="cart-remove-item"),
    ...
    path("addresses/<int:pk>/", views.AddressViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name="address-detail"),

    # ✅ Payment
    path("payments/", views.PaymentViewSet.as_view({'get': 'list', 'post': 'create'}), name="payment-list"),
    path("payments/<int:pk>/", views.PaymentViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name="payment-detail"),
